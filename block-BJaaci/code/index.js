...
movies[0].actors.forEach(actor => console.log(actor));
...
movies[2].genres.forEach(str => console.log(str));

// 13. Log all the genres of the first movie
movies[0].genres.forEach(str => console.log(str));
...
movies[0].genres.forEach(genres => console.log(genres));

// 19. Log all the genres of the second movie one by one
movies[1].genres.forEach(genres => console.log(genres));
...
movies.filter(year => console.log(year.year));
// 23. Log the title of all three movies one by one.
movies.filter(title => console.log(title.title));
